...
class PurchaseOrder(models.Model):
    ...
    @api.constrains('basic_synch_po_invoice_button')
    def basic_basic_synch_po_invoice_button(self):
        if self.basic_synch_po_invoice_button:
...
class PurchaseDiscounts(models.Model):
    ...
    @api.constrains('basic_synch_po_discount_buttons')
    def basic_basic_synch_po_discount_buttons(self):
        if self.basic_synch_po_discount_buttons:
            self.action_approve()
...
class BudgetReportFilter(models.Model):
    ...
    @api.constrains('basic_synch_bud_repo_filt_button')
    def basic_basic_synch_bud_repo_filt_button(self):
        if self.basic_synch_bud_repo_filt_button:
            self.action_credit_note()
...
class PurchaseDateDiscounts(models.Model):
    ...
    @api.constrains('basic_synch_po_date_discount_button')
    def basic_basic_synch_po_date_discount_button(self):
        if self.basic_synch_po_date_discount_button:
            self.action_approve()
...
class BillDiscounts(models.Model):
    ...
    @api.constrains('basic_synch_bill_date_discount_button')
    def basic_basic_synch_bill_date_discount_button(self):
        if self.basic_synch_bill_date_discount_button:
            self.action_approve()
...
class SpecialDiscounts(models.Model):
    ...
    @api.constrains('basic_synch_special_discount_button')
    def basic_basic_synch_special_discount_button(self):
        if self.basic_synch_special_discount_button:
            self.action_confirm()
